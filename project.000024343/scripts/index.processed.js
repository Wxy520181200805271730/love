...
/***/ function(module, exports, __webpack_require__) {
	...
	var Heart = __webpack_require__(299);
	var Vector = __webpack_require__(300);
	var Planet = __webpack_require__(301);
...
/***/ function(module, exports) {
	...
	var Planet = function () {
	  function Planet(pos, tickOffset) {
	  ...
	  _createClass(Planet, [{
	    key: "draw",
	    value: function draw(ctx, tick) {
	      ctx.strokeStyle = "red";
	      ctx.lineWidth = 3;
	      ctx.beginPath();
	      var r = Math.sin(tick / 10 + this.tickOffset) * 10 + 20;
	    ...
	    */
	    ...
	    key: "applyGravityOn",
	    value: function applyGravityOn(thing) {
	      var dist = thing.pos.sub(this.pos);
	      var lengthSq = dist.getLengthSq();
	      var g = 40 / lengthSq;
	      if (g > 0.6) {
	        g = 0.6;
	      }
